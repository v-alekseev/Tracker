...
final class CreateGroupViewController: UIViewController {
    ...
    private var isUpdateAction: Bool
    private var currentCategoryName: String?
    
    init(isUpdateAction: Bool, currentCategory: String? = nil) {
    ...
    lazy var createGroupButton: UIButton = {
        ...
        button.setTitle(isUpdateAction ? "Готово" : "Добавить категорию", for: .normal)
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = self.isUpdateAction ? "Редактирование категории" : "Новая категория"
